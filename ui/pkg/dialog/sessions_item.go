...
// SessionItem wraps a [kernel.Session] to implement the [ListItem] interface.
...
// sessionItems takes a slice of [kernel.Session]s and convert them to a slice
// of [ListItem]s.
func sessionItems(t *styles.Styles, mode sessionsMode, sessions ...kernel.Session) []list.FilterableItem {
