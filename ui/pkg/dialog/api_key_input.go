...
func (m *APIKeyInput) verifyAPIKey() tea.Msg {
	...
	err := m.com.KernelWorkspace.TestProviderConnection(m.provider, m.input.Value())
...
func (m *APIKeyInput) saveKeyAndContinue() Action {
	err := m.com.KernelWorkspace.SetProviderAPIKey(kernel.ScopeGlobal, m.provider.ID, m.input.Value())
	if err != nil {
