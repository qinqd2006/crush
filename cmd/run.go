...
import (
	...
	"github.com/qinqd2006/crush/crush-agent/format"
	"github.com/qinqd2006/crush/crush-agent/proto"
	"github.com/qinqd2006/crush/crush-agent/pubsub"
...
crush run --continue "Follow up on your last response"
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		kernelWs, ok := ws.(*workspace.KernelWorkspace)
		if !ok {
			return fmt.Errorf("expected KernelWorkspace for non-interactive run")
		}
		return kernelWs.App().RunNonInteractive(ctx, os.Stdout, prompt, largeModel, smallModel, quiet || verbose, sessionID, useLast)
	},
}
