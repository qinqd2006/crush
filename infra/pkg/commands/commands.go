...
// dataDir is the data directory (e.g., ".crush") where project commands are stored.
func LoadCustomCommands(dataDir string) ([]CustomCommand, error) {
	return loadAll(buildCommandSources(dataDir))
}
...
func buildCommandSources(dataDir string) []commandSource {
	return []commandSource{
		...
		{
			path:   filepath.Join(dataDir, "commands"),
