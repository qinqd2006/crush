...
type Workspace interface {
	...
	UpdatePreferredModel(scope config.Scope, modelType kernel.SelectedModelType, model kernel.SelectedModel) error
	...
	// Kernel returns the underlying Kernel instance for decoupled access.
	// Returns nil if the workspace does not use a kernel-based implementation.
