...
// KernelSaveSession saves a session using kernel.Session type.
func (w *KernelWorkspace) KernelSaveSession(ctx context.Context, session kernel.Session) (kernel.Session, error) {
	return w.kernel.SaveSession(ctx, session)
}

// KernelDeleteSession deletes a session by ID.
func (w *KernelWorkspace) KernelDeleteSession(ctx context.Context, sessionID string) error {
	return w.kernel.DeleteSession(ctx, sessionID)
}
