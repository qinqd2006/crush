...
// ToolName constants for built-in tools.
const (
	ToolNameBash            = "bash"
	ToolNameEdit            = "edit"
	ToolNameWrite           = "write"
	...
	ToolNameTodo            = "todo"
	ToolNameJob             = "job"
	ToolNameJobKill         = "job_kill"
	ToolNameJobOutput       = "job_output"
	ToolNameMCPTools        = "mcp_tools"
	ToolNameMCPResources    = "mcp_resources"
	ToolNameMCPPrompts      = "mcp_prompts"
	ToolNameReadMCPResource = "read_mcp_resource"

	// Extended tool names (used by UI but not in kernel)
	ToolNameSourcegraph = "sourcegraph"
	ToolNameDiagnostics = "lsp_diagnostics"
	ToolNameWebFetch    = "web_fetch"
	ToolNameWebSearch   = "web_search"
	ToolNameReferences  = "lsp_references"
	ToolNameLSPRestart  = "lsp_restart"
	ToolNameAgent       = "agent"
)

// BashPermissionsParams holds permission info for the bash tool.
...
// EditPermissionsParams holds permission info for the edit tool.
...
// WritePermissionsParams holds permission info for the write tool.
...
// MultiEditPermissionsParams holds permission info for the multiedit tool.
...
// ViewPermissionsParams holds permission info for the view tool.
...
// DownloadPermissionsParams holds permission info for the download tool.
...
// FetchPermissionsParams holds permission info for the fetch tool.
...
// AgenticFetchPermissionsParams holds permission info for the agentic fetch tool.
type AgenticFetchPermissionsParams struct {
	URL    string `json:"url,omitempty"`
	Prompt string `json:"prompt"`
}

// LSPermissionsParams holds permission info for the ls tool.
...
type Kernel interface {
	...
	// GetActiveAgent returns the name of the currently active agent.
	GetActiveAgent() string

	// SetActiveAgent sets the active agent by name.
